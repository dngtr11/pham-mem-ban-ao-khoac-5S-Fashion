 ...
 * @author anh
 */
public class ViewCachThucDongCua extends javax.swing.JFrame {

    /** Creates new form ViewKieuMu */
    DefaultTableModel model = new DefaultTableModel();
    KhoaCaiServiceImpl service = new KhoaCaiServiceImpl();
    public ViewCachThucDongCua() {
        initComponents();
        setDefaultCloseOperation(DISPOSE_ON_CLOSE);
        model = (DefaultTableModel) tbKhoa.getModel();
        showData(service.getAll());
    }
    void showData(List<CachThucDongCua> list){
        model.setRowCount(0);
        for (CachThucDongCua khoa : list) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewCachThucDongCua.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
